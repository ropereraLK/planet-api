...
class PlanetControllerInitTest {
	...
	@Test
	public void testWthParameter3() throws Exception {
		mvc.perform(get("/?planetName=dluto"))
		.andExpect(content().string("Hello dluto"));
		
		
	}
	
	@Test
	public void testWthParametere3() throws Exception {
		mvc.perform(get("/?planetName=dluto"))
		.andExpect(content().string("Hello dluto"));
